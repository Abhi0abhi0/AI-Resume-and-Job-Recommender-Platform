    ...
    const cardsData = [
        {
            ...
            name: 'Rohit Sharma',
            handle: '@rohit_dev',
            text: 'This resume builder is fantastic! It completely transformed my job search and helped me land a great role.'
        },
        {
            image: 'https://images.unsplash.com/photo-1535713875002-d1d0cf377fde?q=80&w=200',
            name: 'Sneha Patel',
            handle: '@snehadesigns',
            text: 'I loved how easy it was to create a professional resume in minutes. Highly recommended!'
        },
        {
            image: 'https://images.unsplash.com/photo-1527980965255-d3b416303d12?w=200&auto=format&fit=crop&q=60',
            name: 'Anil Kumar',
            handle: '@anilkumar_pm',
            text: 'The ATS-friendly templates are amazing. My profile gets shortlisted much faster now.'
        },
        {
            image: 'https://images.unsplash.com/photo-1522075469751-3a6694fb2f61?w=200&auto=format&fit=crop&q=60',
            name: 'Priya Gupta',
            handle: '@priya_writes',
            text: 'Creating my CV was an absolute breeze. The content suggestions provided were incredibly helpful.'
        },
    ];
